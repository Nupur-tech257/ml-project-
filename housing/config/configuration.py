...
class Configuration:
    def __init__(self,
        ...
        current_time_stamp:str = TIME_STAMP
        ) -> None:
        try:
    ...
    def get_data_validation_config(self)->DataValidationConfig:
        try:
            ...
            data_validation_info[DATA_VALIDATION_SCHEMA_FILENAME]
            )

            report_file_path = os.path.join(data_validation_artifact_dir,
            data_validation_info[DATA_VALIDATION_REPORT_FILENAME]
            )

            report_page_file_path = os.path.join(data_validation_artifact_dir,
            data_validation_info[DATA_VALIDATION_REPORT_PAGE_FILENAME]
    ...
    def get_data_transformation_config(self)->DataTransformationConfig:
        try:
            ...
            add_bedroom_per_room=data_transformation_info[DATA_TRANSFORMATION_ADD_BEDROOM_PER_ROOM]
            ...
            preprocessed_object_file_path=os.path.join(data_transformation_artifact_dir,data_transformation_info[DATA_TRANSFORMATION_PREPROCESSING_DIR],data_transformation_info[DATA_TRANSFORMATION_PREPROCESSING_OBJECT_FILENAME])
            
            data_transformation_config=DataTransformationConfig(add_bedroom_per_room=add_bedroom_per_room, transformed_train_dir=transformed_train_dir, transformed_test_dir=transformed_test_dir, preprocessed_object_file_path=preprocessed_object_file_path)
